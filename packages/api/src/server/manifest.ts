...
import { Manifest, ManifestQueryResponse, ManifestSubmitResponse, ValidateManifestRequest, ValidateManifestResponse } from '../models/manifestPreview';
...
export const findManifest = async (skip: number, limit: number, ballot_id: string): Promise<Manifest[] | undefined> => {
